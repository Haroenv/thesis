...
The JS Helper was born in 2015 as part of the JS client\cite{algolia-blog-js-client} with as its main feature handling state of a search experience. This means
