...
\begin{itemize}
  ...
  \item The hosted \acrshort{api}, which is constantly updated, comes with 10 clients, 3 mobile \acrfullpl{sdk} and comprehensive documentation.
\end{itemize}
...
Algolia is divided into several ``squads''\footnote{The exact name of these squads and what their mission is, evolves over time}. According to an internal handbook an Algolia squad is
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{open-space-.jpg}
